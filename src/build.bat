...
cl /nologo %CommonCompilerFlags% -I../src/glad/include/ -I../src/glfw/include/ -I../src/glm/ -I../src/assimp/include/ ../src/glad/src/glad.c ..\src\opengl.cpp /link /NODEFAULTLIB:LIBCMTD %AdditionalLinkerFlags% gdi32.lib opengl32.lib kernel32.lib user32.lib shell32.lib ../src/glfw/build/src/Debug/glfw3.lib ../src/assimp/assimpd.lib
